...
const ViewCardModalRightHeader = ({
	onEditSubmit,
}: ViewCardModalRightHeaderProps) => {
	return (
		<View
			style={{
...
const ViewCard = ({ navigation, cardInfo }: StateProps): JSX.Element => {
	...
	React.useLayoutEffect(() => {
		navigation.setOptions({
			...
			headerRight: () => (
				<ViewCardModalRightHeader onEditSubmit={onEditSubmit} />
			),
		});
	});
		...
		<View style={CreateCardModalStyle.container}>
			<View style={CreateCardModalStyle.topContainer}>
				...
				<View style={CreateCardModalStyle.descriptionContainer}>
					...
					<MarkdownView>{cardInfo.description ?? ''}</MarkdownView>
				</View>
			</View>
			<View style={CreateCardModalStyle.bottomContainer}>
				...
				<View style={CreateCardModalStyle.fieldContainer}>
					<Text style={CreateCardModalStyle.inputLabelDark}>Start Date</Text>
					{Platform.OS === 'ios' ? (
						<DateTimePicker
