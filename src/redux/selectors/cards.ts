...
export const selectCardByUID = (uid: string | undefined) => (state: RootState): CardModelWithUid | undefined => !uid ? undefined : Object.values(state.cards).filter(card => card.uid === uid)[0]; 
